        ...
        {isTripFlightData.map((flightData, index) => (
            ...
            {isExpandedTripCardIndex === index && (
                <div id="expanded-tripCard" className="fixed top-[50px] left-[300px] bg-white ring-1 ring-black ring-opacity-5 w-[800px] h-[730px] text-gray-700 font-normal rounded-lg shadow-md z-30 overflow-auto">
                    ...
                    <div className = "relative top-[30px] left-[40px] font-bold text-xl">Your Trip to {flightData.flight.destinationCity}</div>
                    ...
                    <div>
                    <div className = "relative top-[100px] left-[40px] font-bold">Flight to {flightData.flight.destinationCity}</div>
                    <div className = "relative top-[102px] left-[40px] text-[15px] text-gray-600">{flightData.flight.departingFlights.noOfStops} stops · 19h 20m</div>
                    ...
                    <div className = "relative top-[14px] left-[70px] text-[12px] text-gray-600">{flightData.flight.departingFlights.departureTime1}</div>
                    <div className = "relative top-[14px] left-[70px] text-sm font-bold">{flightData.flight.departingFlights.airport1}</div>
                    <div className = "relative top-[42px] left-[70px] text-[12px] text-gray-600">{flightData.flight.departingFlights.arrivalTime1}</div>
                    <div className = "relative top-[42px] left-[70px] text-sm font-bold">{flightData.flight.departingFlights.airport2}</div> 
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.departingFlights.airline1}</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.departingFlights.flightNumber1} · Economy</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">Flight time {flightData.flight.departingFlights.duration1}</div>
                    <div className = "relative top-[-90px] left-[525px] w-[26px]">
                    <img src={`data:image/jpeg;base64,${flightData.flight.departingFlights.airline1Logo}`} />
                        </div>
                    </div>
                ...
                {/* below is the first layover and the dotted line segment */}
                   {flightData.flight.departingFlights.noOfStops > 0 && (
                    <div className = "relative top-[-77px]">
                        <div className = "relative top-[77px] left-[130px] text-sm">Layover {flightData.flight.departingFlights.layoverTime1}</div>
                    ...
                    <div className = "relative top-[14px] left-[70px] text-[12px] text-gray-600">{flightData.flight.departingFlights.departureTime2}</div>
                    <div className = "relative top-[14px] left-[70px] text-sm font-bold">{flightData.flight.departingFlights.noOfStops < 2 ? flightData.flight.departingFlights.originAirport : flightData.flight.departingFlights.airport2}</div>
                    <div className = "relative top-[42px] left-[70px] text-[12px] text-gray-600">{flightData.flight.departingFlights.arrivalTime2}</div>
                    <div className = "relative top-[42px] left-[70px] text-sm font-bold">{flightData.flight.departingFlights.airport3}</div> 
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.departingFlights.airline2}</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.departingFlights.flightNumber2} · Economy</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">Flight time {flightData.flight.departingFlights.duration2}</div>
                    <div className = "relative top-[-90px] left-[525px] w-[26px]">
                    <img src={`data:image/jpeg;base64,${flightData.flight.departingFlights.airline2Logo}`} />
                        </div>
                    </div>
                    ...
                    <div className = "relative top-[77px] left-[130px] text-sm">Layover {flightData.flight.departingFlights.layoverTime2}</div>
                    <div className = "relative top-[-7px] left-[48px] text-[15px] font-thin text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1" height="130" viewBox="0 0 1 100"> <path d="M0.5 0v130" stroke="black" stroke-width="1" stroke-dasharray="4 4"/> </svg>
                    </div>
                    <div className = "relative top-[-75px] left-[100px]">
                    ...
                    <div className = "relative top-[14px] left-[70px] text-[12px] text-gray-600">{flightData.flight.departingFlights.departureTime3}</div>
                    <div className = "relative top-[14px] left-[70px] text-sm font-bold">{flightData.flight.departingFlights.airport3}</div>
                    <div className = "relative top-[42px] left-[70px] text-[12px] text-gray-600">{flightData.flight.departingFlights.arrivalTime3}</div>
                    <div className = "relative top-[42px] left-[70px] text-sm font-bold">{flightData.flight.departingFlights.destinationAirport}</div> 
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.departingFlights.airline3}</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.departingFlights.flightNumber3} · Economy</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">Flight time {flightData.flight.departingFlights.duration3}</div>
                    <div className = "relative top-[-90px] left-[525px] w-[26px]">
                    <img src={`data:image/jpeg;base64,${flightData.flight.departingFlights.airline3Logo}`} />
                        </div>
                    </div>
                    ...
                    <div className = "relative top-[100px] left-[40px] font-bold">Flight to {flightData.flight.originCity}</div>
                    <div className = "relative top-[102px] left-[40px] text-[15px] text-gray-600">{flightData.flight.returningFlights.noOfStops} stops · 30h 55m</div>
                    ...
                    <div className = "relative top-[14px] left-[70px] text-[12px] text-gray-600">{flightData.flight.returningFlights.departureTime1}</div>
                    <div className = "relative top-[14px] left-[70px] text-sm font-bold">{flightData.flight.returningFlights.airport1}</div>
                    <div className = "relative top-[42px] left-[70px] text-[12px] text-gray-600">{flightData.flight.returningFlights.arrivalTime1}</div>
                    <div className = "relative top-[42px] left-[70px] text-sm font-bold">{flightData.flight.returningFlights.airport2}</div> 
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.returningFlights.airline1}</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.returningFlights.flightNumber1} · Economy</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">Flight time {flightData.flight.returningFlights.duration1}</div>
                    <div className = "relative top-[-90px] left-[525px] w-[26px]">
                    <img src={`data:image/jpeg;base64,${flightData.flight.returningFlights.airline1Logo}`} />
                        </div>
                    </div>
                    ...
                    <div className = "relative top-[-77px]">
                    <div className = "relative top-[77px] left-[130px] text-sm">Layover {flightData.flight.returningFlights.layoverTime1}</div>
                    <div className = "relative top-[-7px] left-[48px] text-[15px] font-thin text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1" height="130" viewBox="0 0 1 100"> <path d="M0.5 0v130" stroke="black" stroke-width="1" stroke-dasharray="4 4"/> </svg>
                    </div>
                    <div className = "relative top-[-75px] left-[100px]">
                    ...
                    <div className = "relative top-[14px] left-[70px] text-[12px] text-gray-600">{flightData.flight.returningFlights.departureTime2}</div>
                    <div className = "relative top-[14px] left-[70px] text-sm font-bold">{flightData.flight.returningFlights.airport2}</div>
                    <div className = "relative top-[42px] left-[70px] text-[12px] text-gray-600">{flightData.flight.returningFlights.arrivalTime2}</div>
                    <div className = "relative top-[42px] left-[70px] text-sm font-bold">{flightData.flight.returningFlights.noOfStops < 2 ? flightData.flight.returningFlights.originAirport : flightData.flight.returningFlights.airport3}</div> 
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.returningFlights.airline2}</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.returningFlights.flightNumber2} · Economy</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">Flight time {flightData.flight.returningFlights.duration2}</div>
                    <div className = "relative top-[-90px] left-[525px] w-[26px]">
                    <img src={`data:image/jpeg;base64,${flightData.flight.returningFlights.airline2Logo}`} />
                        </div>
                    </div>
                    ...
                    <div className = "relative top-[-287px]">
                    <div className = "relative top-[77px] left-[130px] text-sm">Layover {flightData.flight.returningFlights.layoverTime2}</div>
                    <div className = "relative top-[-7px] left-[48px] text-[15px] font-thin text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1" height="130" viewBox="0 0 1 100"> <path d="M0.5 0v130" stroke="black" stroke-width="1" stroke-dasharray="4 4"/> </svg>
                    </div>
                    <div className = "relative top-[-75px] left-[100px]">
                    ...
                    <div className = "relative top-[14px] left-[70px] text-[12px] text-gray-600">{flightData.flight.returningFlights.departureTime3}</div>
                    <div className = "relative top-[14px] left-[70px] text-sm font-bold">{flightData.flight.returningFlights.airport3}</div>
                    <div className = "relative top-[42px] left-[70px] text-[12px] text-gray-600">{flightData.flight.returningFlights.arrivalTime3}</div>
                    <div className = "relative top-[42px] left-[70px] text-sm font-bold">{flightData.flight.returningFlights.originAirport}</div> 
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.returningFlights.airline3}</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">{flightData.flight.returningFlights.flightNumber3} · Economy</div>
                    <div className = "relative top-[-35px] left-[570px] text-[12px] text-gray-600">Flight time {flightData.flight.returningFlights.duration3}</div>
                    <div className = "relative top-[-90px] left-[525px] w-[26px]">
                    <img src={`data:image/jpeg;base64,${flightData.flight.returningFlights.airline3Logo}`} />
                        </div>
                    </div>
                    ...
                    <div className = "relative top-[-1350px] left-[40px] font-bold text-xl">${flightData.flight.totalFlightPrice}</div>
